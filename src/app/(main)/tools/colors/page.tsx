...
export const metadata: Metadata = {
  ...
  description:
    "Harmonize colors, extract palettes from images, generate analogous, triadic, and complementary shades instantly. Supported by Qal Technologies and developer Pascodez.",
  keywords: [
