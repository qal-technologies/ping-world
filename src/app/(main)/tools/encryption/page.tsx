// jules edit: Created Server-side page route wrapper to support dynamic SEO, Open Graph & Twitter Card metadata loading, with Suspense fallback for useSearchParams
...
export const metadata: Metadata = {
  ...
  description:
    "Securely encrypt and decrypt messages entirely client-side using robust AES, TripleDES, and RC4 algorithms. Powering private communications with Qal Technologies & Pascodez.",
  keywords: [
    "AES Encryption",
