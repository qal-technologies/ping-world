...
export const metadata: Metadata = {
  ...
  description:
    "Switch seamlessly between rich document editing and modern visual social media post card creation. Provided by Qal Technologies and engineered by Pascodez.",
  keywords: [
    "Text Editor",
    "Post Card Maker",
