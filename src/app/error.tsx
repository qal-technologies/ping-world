...
// jules edit: Sleek themed dark glassmorphism Global Error Page
...
export default function Error({
  ...
  return (
    <div className='min-h-screen bg-[#0A0C1B] text-pw-text flex items-center justify-center p-6 font-body relative overflow-hidden'>
      {/* Background glow */}
      <div className='absolute -top-40 -left-40 w-96 h-96 bg-pw-danger/10 rounded-full blur-[120px]' />
      <div className='absolute -bottom-40 -right-40 w-96 h-96 bg-pw-primary/10 rounded-full blur-[120px]' />
      ...
      <Card className='max-w-md w-full bg-white/[0.02] border border-white/10 rounded-[32px] p-8 sm:p-10 text-center backdrop-blur-xl shadow-2xl relative z-10'>
        ...
        <p className='text-pw-muted text-sm leading-relaxed mb-8 max-w-xs mx-auto'>
          An unexpected error occurred in this section or server connection. Please try recovering or navigating away.
        </p>
