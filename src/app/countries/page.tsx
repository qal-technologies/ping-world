...
export const metadata: Metadata = {
  ...
  description:
    "Explore worldwide statistics, capitals, currencies, major ethnicities, languages, and populations in-depth. Powered by Qal Technologies and engineered by Pascodez.",
  keywords: [
    "Country Search",
    "Country Information",
    "Demographics",
