...
import { Type, Palette, Plus, Trash2, Download, Layers } from 'lucide-react';
        ...
        <div className=' w-full relative flex flex-col items-center mb-2'>
          <div
            ...
            {state.canvasTextOverlays.length === 0 && (
              <p className='text-white/30 text-sm lg:text-lg font-semibold'>
              ...
              <div
                ...
                className={cn(
                  ...
                  selectedOverlayIdx === i &&
                    'ring-1 ring-white/50 rounded px-1',
                )}
                style={{
                  top: `${overlay.y}%`,
                  left: `${overlay.x}%`,
