...
export const toolDocsDb: Record<string, ToolDoc> = {
  quizzable: {
    ...
    features: [
      ...
      {
        title: "Distraction-Free Assessment View",
        description: "When your audience opens your shared quiz link, the platform automatically triggers an optimized full-screen overlay. It completely hides the global navigation bars, brand footers, and dashboard menus. This ensures participants maintain absolute, laser-focused concentration on the assessment questions without any visual clutter.",
        introduced: "2.0"
      }
    ],
